# Stage 6: Unified Representation & Chunking
...
files (formulas, tables, figures) from step 1; one chunked JSON/JSONL index
per strategy run from step 2, ready for embedding and indexing into a
vector store.
